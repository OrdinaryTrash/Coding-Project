...
#TIC TAC TOE BUT YOUR LAST FEW TURNS GET REMOVED!! So theres always only like 3 of your symbol on the board

#Everything here works already for base Tic Tac Toe now you just gotta figure out how to do the rest
#I'm assuming a system that counts the turn it is on and then clear a spot on the board after it saves it so on turn 0 -
# - it saves the position of the symbol you put and then by turn 4 it deletes those and so on but then you would need to save turn 1 and 2 and 3 and 4 blah blah blah no clue figure it out

#Make a list of pointers that point to the adress and have it constantly check for the amount in the list (limit of 4 maybe?)
#And when you add the fifth element it removes the last element in the list or so.


#WE ARE GOING TO BE USING A DEQUE TO STORE INFO FOR PLAYER MOVE !!!


#Alright so basically I'm a fucking idiot who doesn't know how to program I was making it read the cords backwords so it was importing them as (x, y)
#and then reading them as (y, x) which if you can't tell is backwords, I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life I hate my life

#POSSIBLE FEATURES

#Easy mode and hard mode
#Bigger Grid
#4 in a row? inside the bigger grid?
